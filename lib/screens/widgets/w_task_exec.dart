// screens/widgets/w_task_exec.dart
import 'package:flutter/material.dart';
import 'w_general.dart';
import 'w_popup_action.dart';
...
Container buildHeaderInfo(String teks) {
  return cfgContainer(
    ...
    15.0,
    20,
    cfgBoxDecoration(const Color(0xFFDCEDC8), 8.0, Colors.green.shade300),
    Alignment.center,
...
Widget _buildTreeButton(
  ...
  switch (pohon.status) {
    case '0':
      iconPath = 'assets/icons/pohon_mati.png';
      break;
    case '2':
      iconPath = 'assets/icons/pohon_ditebang.png';
      break;
    case '3':
